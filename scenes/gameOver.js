class gameOver extends Phaser.Scene {
  ...
  create() {
    ...
    graphics.lineStyle(5, 0x00ff00, 10);
    ...
    this.statsText = this.add.bitmapText(game.config.width / 2, game.config.height / 2 - 75, 'topaz', 'Win', 60).setOrigin(.5).setTint(0xcbf7ff).setAlpha(1);
